...
const Index: React.FC<IndexProps> = () => {
  ...
  return (
    <div dir={isArabic ? "rtl" : "ltr"} className="w-full">
      <h1 className="text-2xl sm:text-3xl font-bold mb-6">{isArabic ? "لوحة التحكم" : "Dashboard"}</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {/* POS Card */}
        <Card className="p-4 sm:p-6 hover:shadow-md transition-shadow h-full">
          <h2 className="text-lg sm:text-xl font-bold mb-2">{isArabic ? "نقطة البيع" : "Point of Sale"}</h2>
        ...
        {/* Invoices Card */}
        <Card className="p-4 sm:p-6 hover:shadow-md transition-shadow h-full">
          <h2 className="text-lg sm:text-xl font-bold mb-2">{isArabic ? "الفواتير" : "Invoices"}</h2>
          <p className="text-muted-foreground mb-4 text-sm">
        ...
        {/* Kitchen Card */}
        <Card className="p-4 sm:p-6 hover:shadow-md transition-shadow h-full">
          <h2 className="text-lg sm:text-xl font-bold mb-2">{isArabic ? "المطبخ" : "Kitchen"}</h2>
          <p className="text-muted-foreground mb-4 text-sm">
        ...
        {user?.role === "admin" && (
          <Card className="p-4 sm:p-6 hover:shadow-md transition-shadow h-full">
            <h2 className="text-lg sm:text-xl font-bold mb-2">{isArabic ? "المنتجات" : "Products"}</h2>
            <p className="text-muted-foreground mb-4 text-sm">
        ...
        {user?.role === "admin" && (
          <Card className="p-4 sm:p-6 hover:shadow-md transition-shadow h-full">
            <h2 className="text-lg sm:text-xl font-bold mb-2">{isArabic ? "المخزون" : "Inventory"}</h2>
            <p className="text-muted-foreground mb-4 text-sm">
        ...
        {user?.role === "admin" && (
          <Card className="p-4 sm:p-6 hover:shadow-md transition-shadow h-full">
            <h2 className="text-lg sm:text-xl font-bold mb-2">{isArabic ? "التقارير" : "Reports"}</h2>
            <p className="text-muted-foreground mb-4 text-sm">
        ...
        {user?.role === "admin" && (
          <Card className="p-4 sm:p-6 hover:shadow-md transition-shadow h-full">
            <h2 className="text-lg sm:text-xl font-bold mb-2">{isArabic ? "الإعدادات" : "Settings"}</h2>
            <p className="text-muted-foreground mb-4 text-sm">
